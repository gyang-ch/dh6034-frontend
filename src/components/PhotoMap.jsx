...
export default function PhotoMap({ semanticMap }) {
  ...
  return (
    <div style={{ display: 'grid', gap: '0.75rem', padding: '1.2rem', border: '1px solid var(--archive-color-rule)', borderRadius: '1.75rem', background: 'linear-gradient(180deg,rgba(255,255,255,0.84),rgba(247,244,237,0.9))', maxWidth: 'min(100%, 1020px)', margin: '0 auto' }}>
