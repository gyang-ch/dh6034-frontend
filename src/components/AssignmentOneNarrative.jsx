...
export default function AssignmentOneNarrative({ prefersReducedMotion = false }) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      figureTiltTargets.forEach((target) => {
