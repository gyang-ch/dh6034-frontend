    ...
    <div style={{ background: 'var(--archive-color-bg)', minHeight: '100vh', color: 'var(--archive-color-ink)' }}>
      ...
      <div style={{ margin: '0 auto', width: 'min(112rem,calc(100vw - 2rem))', padding: '0 1.5rem 6rem' }}>
        ...
        <section id="methodology" style={SEC}>
          ...
          <p style={S.body}>
            To capture semantic and contextual information, I used a combination of computer vision and vision–language models. I applied YOLO to detect objects in each image, including people counts. As noted earlier, object detection only provides coarse counts and does not capture social relationships. 
          </p>
          <p style={S.body}>
