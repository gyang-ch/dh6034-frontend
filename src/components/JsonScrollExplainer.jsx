...
const STEPS = [
  ...
  },
  {
    ...
    explanation: 'Captions and keywords generated by vision-language models. I initially used BLIP, and later added Gemma, which produced more accurate semantic descriptions',
  },
  {
    id: 'yolo',
    ...
    explanation: 'YOLO detects object classes in each image, stored as a count map. An empty object means no detected objects.',
  },
  {
    id: 'colours',
    ...
    explanation: 'The top five colours extracted by k-means on the pixel palette, stored as hex, RGB, and HSL saturation.',
  },
  {
    id: 'clip',
    title: 'Semantic Tags',
    ...
    explanation: 'Candidate tags scored by cosine similarity between the image embedding and tag text embeddings in CLIP space.',
  },
  {
    id: 'stats',
    ...
    explanation: 'Pixel dimensions, aspect ratio, per-channel mean and standard deviation, brightness, RMS contrast, and Shannon entropy.',
  },
  {
    id: 'umap',
